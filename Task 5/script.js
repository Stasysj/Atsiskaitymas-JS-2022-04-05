...
const rezultatas1 = filterDogOwners(users);
console.log('1. "users", kurie turi augintinį== ', rezultatas1);
//--------------------------------------
function filterAdults(arr) {
  return arr.filter((obj) => obj.age >= 18);
}

const rezultatas2 = filterAdults(users);
console.log('2. "users", kurie yra pilnamečiai==', rezultatas2);
